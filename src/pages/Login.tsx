      ...
      <div className="w-[516px] h-[539px] bg-gray-100 rounded-md rounded-2 p-2">
        <div className="mb-0 rounded-md border-4 border-customBlue">
          ...
          >
            ...
            <h2 className="text-gray-500/60 font-bold text-center py-3 font-16">
              SIGN IN
            </h2>
            ...
            <div className="mt-4">
              <a
                ...
                className="text-gray-500/60 font-semibold text-sm hover:underline"
              >
            ...
            <div className="mt-16 text-center">
              <p className="text-lg text-gray-500/60 font-bold mb-6">
                Sign in with
              </p>
              <div className="flex justify-center gap-1">
                <Button className="bg-customFacebook text-white p-2 rounded-md">
                  <img
                    src={facebookPlusIcon}
                    alt="Facebook"
                ...
                <Button className="bg-customTwitter text-white p-2 rounded-md">
                  <img
                    src={twitterPlusIcon}
                    alt="Twitter"
                    className="h-6 w-7 opacity-90 mr-1"
                  />{" "}
                  Twitter
                </Button>
